...
$scriptBlock = {
    ...
    choco install MSIDemo --version 3.0.0 --package-parameters="'/filelocation:\\BG4PHS29EPCOVM1\shared\MSIDemo.msi /arguments:/qn%space%/norestart'" --source 'https://sonatapoc.jfrog.io/artifactory/api/nuget/chocopackages-nuget/' -y --force --user='sharad1' --password='Sharad@123'
