...
function Install-NewVersion {
    ...
    $scriptBlock = {
        ...
        choco install $packageName --version $version --package-parameters=`"`'$packageParameters`'`" --source "$jFrogArtifactoryUrl/artifactory/api/nuget/$jFrogRepository/" --user="sharad1" --password="Sharad@123" -y --force
    }
